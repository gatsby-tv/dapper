...
func createNode(ctx context.Context, repoPath string) (icore.CoreAPI, error) {
	...
	config.Addresses.Swarm = []string{"/ip4/0.0.0.0/tcp/4001", "/ip6/::/tcp/4001", "/ip4/0.0.0.0/udp/4001/quic", "/ip6/::/udp/4001/quic", "/ip4/0.0.0.0/tcp/8085/ws", "/ip6/::/tcp/8085/ws", "/dns4/staging.gatsby.sh/tcp/8081/wss/ipfs/12D3KooWC3FCg8mepBicz1pFxRyUzQR5rvrjDHRKFXr1cP2dfZmL"}
...
func connectToPeers(ctx context.Context, ipfs icore.CoreAPI, peers []string) error {
	...
	for _, addrStr := range peers {
		...
		if err != nil {
			log.Warn().Err(err).Msgf("Invalid peer address: %s", addr)
			return err
		}
